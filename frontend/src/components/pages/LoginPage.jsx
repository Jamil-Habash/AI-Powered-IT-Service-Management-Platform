...
export default function LoginPage() {
  ...
  return <div className="login-page">
    <main className="login-card">
        ...
        <form onSubmit={(event) => { event.preventDefault(); navigate('/dashboard') }}>
            <label>Email Address<input type="email" placeholder="Enter your work email" required /></label>
            <label>Password
        ...
        <p>Don't have an account? <Link to="/register">Create employee account</Link></p>
        <footer>
